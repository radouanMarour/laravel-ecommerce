...
function EditProduct({ auth, product, categories }) {
    ...
    const [thumbnailPreviews, setThumbnailPreviews] = useState(product.thumbnail_images || []);
        ...
        <Dashboard auth={auth}>
            <div className="bg-[#0D1B2A] text-white p-6 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label className="block mb-2">Thumbnail Images</label>
                        <div className="flex items-center space-x-4">
                            <label className="cursor-pointer bg-blue-600 px-4 py-2 rounded flex items-center hover:bg-blue-700">
                                <FaUpload className="mr-2" />
                                Choose Thumbnails
                    ...
                    <div className="flex justify-end space-x-3">
                        ...
                        >
                            {processing ? "Editing..." : "Edit Product"}
                        </button>
                    </div>
                </form>
            </div>
